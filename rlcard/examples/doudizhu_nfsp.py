...
with tf.Session() as sess:
    ...
    for episode in range(episode_num):
        ...
        if episode % evaluate_every == 0:
            ...
            logger.log('\n########## Evaluation ##########')
            logger.log('episode: {} Average reward is {}'.format(episode/evaluate_every, float(reward)/evaluate_num))

            # Add point to logger
            logger.add_point(x=episode/evaluate_every, y=float(reward)/evaluate_num)
