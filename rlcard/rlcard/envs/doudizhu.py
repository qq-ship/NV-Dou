...
class DoudizhuEnv(Env):
    ...
    def extract_state(self, state):
        ...
        extrated_state = {'obs': obs, 'legal_actions': self.get_legal_actions(),'all_actions':state['all_actions']}
    ...
    def decode_action(self, action_id):
        ...
        #print("abstract_action is:",abstract_action)
        ...
        #print("legal_actions is:",legal_actions)
        specific_actions = []
        kickers = []
        ...
        #print("kickers", kickers, "specific_actions", specific_actions)
        ...
        for index, score in enumerate(kicker_scores):
            if score < min_score:
                min_score = score
                min_index = index
        #print ("specific_actions[min_index]:",specific_actions[min_index])
