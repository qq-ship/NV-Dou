...
from game_model.a3c_doudizhu_game_agent_test import TWorker
import threading
import datetime
...
if __name__ == "__main__":
    ...
    workers = [TWorker(gnet, opt, global_ep, global_ep_r, res_queue,i,100,10,0.9) for i in range(1)]

    threads = [threading.Thread(target=worker.test) for worker in workers]
