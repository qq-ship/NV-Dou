...
class Logger(object):
    ...
    def __init__(self, xlabel = '', ylabel = '',zlabel='',mlabel='',legend = '', log_path = None, csv_path = None):
        ...
        if csv_path is not None:
            ...
            self.csv_file.write(xlabel+','+ylabel+','+zlabel+','+mlabel+'\n')
            self.csv_file.flush()
    ...
    def add_point(self, x = None, y = None,z = None,m=None):
        ...
        if self.csv_path is not None:
            self.csv_file.write(str(x)+','+str(y)+','+str(z)+','+str(m)+'\n')
            self.csv_file.flush()
